...
export default function FirstPerson(props) {
...
{item.email.charAt(0).toUpperCase()}        
        ...
        {index === data.length - 1 ? <React.Fragment> <br /> <a 
        // onClick={this.loadM}
         href='#' ><i class="fas fa-chevron-circle-down"></i> load more</a> </React.Fragment> : ''}
        {
          index === data.length - 1 && 
  ...
  return (
    <div>
            ...
            
      {
        ...
        renderMessages('muhammadhamza@gmail.com',chatState.data) 
      }
    </div>
  )
}
